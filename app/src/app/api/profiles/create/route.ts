...
import { validateRequest, schemas, createSecureErrorResponse, addSecurityHeaders } from '@/lib/security';
...
export async function POST(req: Request) {
  try {
    ...
    if (existingProfile) {
      return addSecurityHeaders(createSecureErrorResponse('Profile with this email already exists', 409));
    }
