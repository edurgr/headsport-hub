      ...
      <div className="flex items-center gap-3">
        ...
        {user ? (
          <>
            <button
              onClick={signOut}
              className="px-3 h-9 inline-flex items-center rounded-md bg-gray-900 text-white text-sm hover:opacity-90 transition-colors dark:bg-gray-50 dark:text-gray-900"
              title="Sign Out"
              aria-label="Sign Out"
            >
              Sign Out
