...
1. **API Routes**: Se convertirán automáticamente en Cloudflare Functions
2. **Static Export**: La aplicación se exportará como archivos estáticos
3. **Environment Variables**: Se configurarán en el dashboard de Cloudflare
4. **Custom Domain**: Se configurará automáticamente con SSL
5. **Deploy**: Automático en cada push a main

## 🔄 **FLUJO DE DEPLOY**

1. **Desarrollo local** → `npm run dev`
2. **Build local** → `npm run build:cloudflare`
3. **Push a GitHub** → Deploy automático en Cloudflare
4. **Verificar** → https://headhub.com
